...
int main(int argc, char **argv){
    ...
    float distances[num_queries];
    
    // for each query, find nearest neighbor
    // (dynamic, 1) distributes 1 iteration loop to each thread
    ...
    for(int q = 0; q < num_queries; ++q){
        ...
        // writing data into array in order to avoid ordered parallel for loop
    ...
    // printing is extracted from for loop for performance advancement
